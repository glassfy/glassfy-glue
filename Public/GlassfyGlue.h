...
+ (void)skuWithId:(NSString *_Nonnull)skuid store:(GYStore)store completion:(GlassfyGlueCompletion _Nonnull )block;
...
+ (void)connectPaddleLicenseKey:(NSString *_Nonnull)licenseKey completion:(GlassfyGlueCompletion _Nonnull )block;
+ (void)connectPaddleLicenseKey:(NSString *_Nonnull)licenseKey force:(BOOL)force completion:(GlassfyGlueCompletion _Nonnull )block;
